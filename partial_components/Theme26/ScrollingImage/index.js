...
export default class ScrollingBackground extends Component {
    constructor(props) {
        ...
        let heightOfAllImagesWithSpaces = 0; // Store sum of height of scaled images
        ...
        this.props.images.forEach(image => {
            ...
            heightOfAllImagesWithSpaces = heightOfAllImagesWithSpaces + localElement.height + this.props.spacing;
            heightOfAllImagesUnscaled = heightOfAllImagesUnscaled + height;
            counter++;
        });

        let timesToDuplicate = Math.ceil(deviceHeight / heightOfAllImagesWithSpaces); // Find out how many times we need to duplicate the image components we already created in order to fill the screen by the time the scrolling animations finishes
        ...
        this.state = {
            ...
            heightOfAllImagesWithSpaces: heightOfAllImagesWithSpaces,
        ...
        if (this.props.direction == "up" || this.props.direction == "left") {
            Animated.loop(
                Animated.sequence([
                    Animated.timing(this.state.topPositionAnimated, {
                        ...
                        duration: this.props.speed * this.state.heightOfAllImages,
            ...
            Animated.loop(
                ...
                Animated.timing(this.state.topPositionAnimated, {
                    toValue: 0,
                    //duration: this.props.speed * this.state.heightOfAllImagesUnscaled,
                    duration: this.props.speed * (this.state.heightOfAllImagesWithSpaces),
                ...
                //     }),
                //     Animated.timing(this.state.topPositionAnimated, {
                //         toValue: -1 * (this.state.heightOfAllImagesWithSpaces),
                //         duration: 0,
                //         delay: 0,
                //         easing: Easing.linear
                //         // useNativeDriver: true // Creates slight lag when loop restarts
        ...
        for (imageComponent of this.state.imageComponents) {
            elements.push(
                <Image
                    ...
                    style={{
                        width: "100%",
                        marginVertical: this.props.spacing,
